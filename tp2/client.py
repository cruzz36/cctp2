...
# Funções de teste não utilizadas - código de desenvolvimento/teste
# def run(num): 
#     client = MissionLink.MissionLink("127.0.0.1",8081 + num)
#     client.server()
...
# Funções de teste não utilizadas - código de desenvolvimento/teste para medir taxa de pacotes
# Estas funções não são usadas porque NMS_Agent já tem get_packet_rate() implementado
# import psutil
# import time
