...
#### No Servidor (Server.py) - Envio de missões:
...
#### No Cliente (Agent.py) - Receção de missões:
...
#### No Cliente (Agent.py) - Solicitação de missão:
...
#### No Servidor (Server.py) - Processamento de pedido:
...
#### No Cliente (Agent.py) - Envio de progresso:
...
#### No Servidor (Server.py) - Receção de progresso:
...
#### No Servidor (Server.py) - Verificação de ACK:
...
**Código comentado** (Server.py, linhas 217-229):
```python
