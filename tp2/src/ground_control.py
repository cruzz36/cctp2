...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Exemplos de uso:
  python scripts/start_ground_control.py                    # Interface interativa (API em localhost:8082)
  python scripts/start_ground_control.py http://10.0.1.10:8082  # Especificar URL da API
  # Nota: Para dashboard único, modificar start_ground_control.py conforme necessário
        """
    )
