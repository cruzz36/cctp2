...
Uso: python3 scripts/start_ground_control.py [API_URL]

Exemplos:
  python3 scripts/start_ground_control.py
  python3 scripts/start_ground_control.py http://10.0.1.10:8082
"""
...
from ground_control import GroundControl  # type: ignore
...
def main():
    ...
    try:
        ...
        if test_data is None:
            ...
            print("  1. A Nave-Mãe está a correr (python3 scripts/start_nms.py)")
            ...
            print("  4. As rotas de rede estão configuradas (ver Guia_CORE_Unificado.md)")
            print("  5. A conectividade de rede está funcionando")
            print("\nDica: Verifique se a Nave-Mãe mostra '[OK] API de Observação iniciada'")
            sys.exit(1)
