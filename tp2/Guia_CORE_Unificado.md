...
- Se não houver internet nos nós (erro de DNS/PyPI), faz offline a partir do host CORE:
  ...
  4. Para cada nó (NaveMae/GroundControl/Rover1/Rover2, um de cada vez), no host:
     ...
     //Qjm ----------------------------------------------------------------------------------
     sudo sh -c "cat /home/core/pkgs.tgz | vcmd -c /tmp/pycore.37179/NaveMae -- sh -c 'tar -xzf - -C /tmp && pip3 install --no-index --find-links /tmp/pkgs flask==1.1.1 itsdangerous==1.1.0 jinja2==2.10.1 markupsafe==1.1.1 werkzeug==0.16.1 click==7.0 psutil==5.9.0 requests==2.22.0'"

     sudo sh -c "cat /home/core/pkgs.tgz | vcmd -c /tmp/pycore.37179/GroundControl -- sh -c 'tar -xzf - -C /tmp && pip3 install --no-index --find-links /tmp/pkgs flask==1.1.1 itsdangerous==1.1.0 jinja2==2.10.1 markupsafe==1.1.1 werkzeug==0.16.1 click==7.0 psutil==5.9.0 requests==2.22.0'"

     sudo sh -c "cat /home/core/pkgs.tgz | vcmd -c /tmp/pycore.37179/Rover1 -- sh -c 'tar -xzf - -C /tmp && pip3 install --no-index --find-links /tmp/pkgs flask==1.1.1 itsdangerous==1.1.0 jinja2==2.10.1 markupsafe==1.1.1 werkzeug==0.16.1 click==7.0 psutil==5.9.0 requests==2.22.0'"

     sudo sh -c "cat /home/core/pkgs.tgz | vcmd -c /tmp/pycore.37179/Rover2 -- sh -c 'tar -xzf - -C /tmp && pip3 install --no-index --find-links /tmp/pkgs flask==1.1.1 itsdangerous==1.1.0 jinja2==2.10.1 markupsafe==1.1.1 werkzeug==0.16.1 click==7.0 psutil==5.9.0 requests==2.22.0'"
     ```
